    ...
    return(
        ...
        <div className="m-8 bg-gray-50 border rounded-2xl py-5">
          <div className="container mx-auto ">
            <div className="flex flex-wrap -mx-12 space-x-4">
              {/* Product Images */}
              ...
              {/* Product Details */}
              <div className="w-full md:w-[44%] px-2 text-xl tracking-wide">
                ...
                <div className='flex  flex-col md:flex-row justify-normal md:space-x-2'>
