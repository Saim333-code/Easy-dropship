...
export default function Usercard(param){
    ...
    console.log(param)
    const {id}=param
    const {Name,Email,Mobile,Brandname,Cnic,Address,Bank,BankAccountNumber,Cardname,Password}=param.params
    const postParams={
        Email,
        Password,
        id,
    ...
    return (
     ...
     />
                ...
                <div className="px-4 py-5 sm:px-6 border-t border-gray-200 bg-gray-50 flex justify-center space-x-4">
                    <button onClick={verifyUser} type="button" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                        Verify
                    </button>
                    <button type="button"
                    onClick={DeleteUser}
